...
function post_type_service()
{
	...
	$labels = array(
		...
		'all_items'             => __('Tất cả Dịch Vụ', 'blog'),
		'add_new_item'          => __('Thêm Dịch Vụ', 'blog'),
		'add_new'               => __('Thêm Dịch Vụ', 'blog'),
		'new_item'              => __('Dịch Vụ mới', 'blog'),
		'edit_item'             => __('Sửa Dịch Vụ', 'blog'),
		'update_item'           => __('Cập nhập Dịch Vụ', 'blog'),
		'view_item'             => __('Xem Dịch Vụ', 'blog'),
		'view_items'            => __('Xem Dịch Vụ', 'blog'),
		'search_items'          => __('Tìm kiếm Dịch Vụ', 'blog'),
		'not_found'             => __('Không tìm thấy Dịch Vụ nào', 'blog'),
		'not_found_in_trash'    => __('Không tìm thấy Dịch Vụ nào', 'blog'),
