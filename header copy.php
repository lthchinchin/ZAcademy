            ...
            <div class="header-top d-lg-flex d-none">
                <div class="container">
                    <div class="header-top-wrap">
                        <div class="company">
                            <span>Bình Garden - Đẳng cấp không gian xanh</span>
                        </div>
                        <div class="contact">
                        ...
                        <div class="phone-number">
                            <div class="search-bar d-xl-block d-none">
                                <div class="position-relative">
                                    <div class="phone-data phone form-control">0777.148.777</div> <a href="tel:0777148777"><button class="btn phone position-absolute top-50 translate-middle-y"><i class="fas fa-phone-alt"></i></button> </a>
                                </div>
                            </div>
                        </div>
                        <div class="logo">
                        ...
                        <div class="search-bar d-xl-block d-none">
                            <div class="position-relative">
                                <form action="<?php echo home_url(); ?>" method="get" id="hv-search-form">
                                    <input name="s" placeholder="Tìm kiếm..." class="form-control"> <button type="submit" class="btn position-absolute top-50 translate-middle-y"><i class="far fa-search"></i></button>
                                </form>
                            </div>
                        </div>
                        <div class="headernav">
